...
import '../../../commons/providers/failure_provider.dart';
import '../../../commons/providers/loader_provider.dart';
...
final loginProvider =
  ...
  final userLocalDataSourceImpl = LoginLocalDataSourceImpl(
...
class LoginState extends StateNotifier<bool?> {
  ...
  LocalAuthRepository localAuthImpl;
